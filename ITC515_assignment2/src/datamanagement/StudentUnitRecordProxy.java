...
package datamanagement;
 ...
 {
	private Integer studentID;//declared integer=studentID
	private String unitCode;  //declared string
...
{ 
	...
	return studentID;//return of studentID
}
	...
	public float getAsg1() 
{
	...
	public void setExam(float mark) {mngr.getStudentUnitRecord( studentID, unitCode ).setExam(mark);//return of setExam which is in float
}
