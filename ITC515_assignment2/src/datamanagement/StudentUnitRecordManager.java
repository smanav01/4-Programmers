...
//class defined studentUnitRecordManger
{

	    private static StudentUnitRecordManager s = null;             //studentUnitRecotdManager=null          
...
public static StudentUnitRecordManager instance()
        ...
        private StudentUnitRecordManager()
 {
     ...
     public IStudentUnitRecord getStudentUnitRecord( Integer studentID, String unitCode ) // variable declared  studentID,UnitCode
//   variables defined in StudentUnitRecord
{
...
public StudentUnitRecordList getRecordsByStudent( Integer studentID ) //method declaration as studentId
